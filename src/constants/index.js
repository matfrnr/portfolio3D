...
const experiences = [
  {
    ...
    type: "Job d'été",
    company_name: "Domaine des monts martins",
    lieu: "Poligny",
    icon: logo_domaine,
    iconBg: "#E6DEDD",
    date: "Juillet 2023 - Aout 2023",
    points: [
      "Développement et amélioration de fonctionnalités sur un site web existant (HTML, CSS, JavaScript).",
      "Mise à jour de contenus et correction de bugs.",
      "Participation à la création d’un petit outil interne (formulaire, back-office léger).",
      "Aide à la maintenance du site : tests, optimisation responsive, vérification des performances.",
    ],
  },
  {
    title: "Tuteur en développement web",
    type: "Job étudiant",
    company_name: "Université Grenoble Alpes - IUT1",
    lieu: "Grenoble",
    icon: iut1Grenoble,
    iconBg: "#E6DEDD",
  ...
  },
  {
    ...
    points: [
      "Maintenance et développement d'une sonde Node.js.",
      "Création d'une application interne pour la gestion des effectifs et du planning.",
